            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('vote.index') }}">رأی‌دهی</a>
                        </li>
                        @auth
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.dashboard') }}">پنل مدیریت</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.results') }}">نتایج</a>
                        </li>
                        @endauth
                    </ul>
                    <!-- چپ -->
